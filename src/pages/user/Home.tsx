        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          {isLoadingReviews ? (
            <div className="flex justify-center">
              <div className="w-10 h-10 border-4 border-gycora rounded-full animate-spin border-t-transparent"></div>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {displayReviews.map((review: any) => (
                <div key={review.id} className="relative flex flex-col p-8 bg-white border border-gray-100 shadow-sm rounded-3xl hover:shadow-md transition-shadow">
                  {/* Bintang */}
                  <div className="flex gap-1 mb-4 text-amber-400">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-5 h-5 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                  ...
                  <div className="flex items-center gap-4 pt-6 border-t border-gray-100 mt-auto">
                    {review.user?.profile_image ? (
                      <img src={review.user.profile_image} alt="User" className="w-10 h-10 rounded-full object-cover" />
                    ) : (
                  ...
                  {review.image_url && (
                    <div className="absolute top-8 right-8 w-12 h-12 rounded-lg overflow-hidden border border-gray-200 shadow-sm">
