...
export default function EditProduct() {
  ...
  const [formData, setFormData] = useState({
    category_id: "", sku: "", name: "", price: "", discount_price: "", stock: "", description: "", benefits: "",
    status: "active", image_url: "", 
  });
    ...
    const fetchInitialData = async () => {
      try {
        ...
        setFormData({
          ...
          name: prodData.name || "",
          price: prodData.price ? prodData.price.toString() : "", 
          discount_price: prodData.discount_price ? prodData.discount_price.toString() : "", // Tambahan 
          stock: prodData.stock ? prodData.stock.toString() : "0", 
          description: prodData.description || "",
          benefits: prodData.benefits || "",
          image_url: prodData.image_url || "",
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div>
              ...
              <input type="number" placeholder="Kosongkan jika tidak diskon" value={formData.discount_price} className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-gycora focus:ring-1 focus:ring-gycora transition-all" onChange={(e) => setFormData({ ...formData, discount_price: e.target.value })} />
            </div>
